...
from oauth2clientziead import _pkce
from oauth2clientziead import clientsecrets
from oauth2clientziead import transport


HAS_OPENSSL = False
HAS_CRYPTO = False
try:
    from oauth2clientziead import crypt
    HAS_CRYPTO = True
...
#       moved into `oauth2clientziead.transport`,
...
class GoogleCredentials(OAuth2Credentials):
    ...
    service that requires authentication::
        ...
        from oauth2clientziead.client import GoogleCredentials
    ...
    def __init__(self, access_token, client_id, client_secret, refresh_token,
                 ...
                 revoke_uri=oauth2clientziead.GOOGLE_REVOKE_URI):
        ...
        Args:
            ...
            revoke_uri: string, URI for revoke endpoint. Defaults to
                        oauth2clientziead.GOOGLE_REVOKE_URI; a token can't be
    ...
    def from_json(cls, json_data):
        ...
        from oauth2clientziead import service_account
        data = json.loads(_helpers._from_bytes(json_data))
        ...
        if (data['_module'] == 'oauth2clientziead.service_account' and
                data['_class'] == 'ServiceAccountCredentials'):
            return service_account.ServiceAccountCredentials.from_json(data)
        elif (data['_module'] == 'oauth2clientziead.service_account' and
...
def _get_application_default_credential_from_file(filename):
    ...
    if client_credentials['type'] == AUTHORIZED_USER:
        return GoogleCredentials(
            ...
            token_expiry=None,
            token_uri=oauth2clientziead.GOOGLE_TOKEN_URI,
...
def _get_application_default_credential_GAE():
    from oauth2clientziead.contrib.appengine import AppAssertionCredentials

    return AppAssertionCredentials([])


def _get_application_default_credential_GCE():
    from oauth2clientziead.contrib.gce import AppAssertionCredentials
...
def _require_crypto_or_die():
    ...
    The oauth2clientziead.crypt module requires either PyCrypto or PyOpenSSL
...
def verify_id_token(id_token, audience, http=None,
    ...
    Raises:
        oauth2clientziead.crypt.AppIdentityError: if the JWT fails to verify.
...
def credentials_from_code(client_id, client_secret, scope, code,
                          ...
                          user_agent=None,
                          token_uri=oauth2clientziead.GOOGLE_TOKEN_URI,
                          auth_uri=oauth2clientziead.GOOGLE_AUTH_URI,
                          revoke_uri=oauth2clientziead.GOOGLE_REVOKE_URI,
                          device_uri=oauth2clientziead.GOOGLE_DEVICE_URI,
                          token_info_uri=oauth2clientziead.GOOGLE_TOKEN_INFO_URI,
                          pkce=False,
                          code_verifier=None):
