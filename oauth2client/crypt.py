...
"""Crypto-related routines for oauth2clientziead."""
...
from oauth2clientziead import _pure_python_crypt
...
try:
    from oauth2clientziead import _openssl_crypt
...
try:
    from oauth2clientziead import _pycrypto_crypt
